...
vendor_name_unsantized=$(ask_question "Vendor name" "tovitch")
...
echo
files=$(grep -E -r -l -i ":author|:vendor|:package|tovitch|skeleton" --exclude-dir=vendor ./*  | grep -v "$script_name")
